...
const Footer = () => {
  return (
    ...
    <Box bgcolor={"#1F1F1F"}>
        ...
        <Stack sx={{pb:5,justifyContent:"space-between",width:"95%",margin:"0 auto",maxWidth:"1500px"}} direction={"row"} >
          <Typography variant="cardLocation1" color="#E3E3E3">© Aranya Crafts Limited  2022</Typography>
